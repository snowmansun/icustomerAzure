...
router.post('/update', function (req, res) {
    var query = 'update contact set LocalModified=1,firstname=\'' + req.body.firstname + '\',lastname=\'' + req.body.lastname + '\',email=\'' + req.body.email + '\',mobilephone=\'' + req.body.mobile + '\' where accountid=\'' + req.body.accountid + '\' and ebmobile__primary__c= 1 ';
    dbHelper.query(query, function (err, result) {
        if (err) {
